...
const Paso4 = (props) => {
  ...
  return (
    <form className="fileform" onSubmit={handleSubmit(irAlSiguientePaso)}>
      <div className="filePicker">
        <input
          ...
          onChange={(e) => {
            ...
            if (!allPDF) return alert("Por favor, suba solo archivos PDF.");
            setFilesInfo((prev) => {
        ...
        <label htmlFor="linkDiagnostico">
          ...
          <span> Adjuntar diagnóstico (PDF)</span>
        </label>
        {filesInfo[0] && (
      ...
      <p className="texto-diagnostico">
        Adjuntar únicamente el documento completo en PDF del informe o
        diagnóstico firmado por el profesional colegiado y en el que conste el
        trastorno de aprendizaje diagnosticado.
      </p>
